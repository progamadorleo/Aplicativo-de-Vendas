...
- API REST (mockada nesta versão pública)
...
Na versão original (privada), o aplicativo se conecta a uma **API real**, responsável pela autenticação, sincronização e persistência dos dados.

👉 **Nesta versão publicada no GitHub**, os dados e itens foram **mockados**, sendo utilizados apenas para **apresentação visual, testes e demonstração da arquitetura**, sem dependência de serviços externos.
...
Este repositório tem como objetivo **demonstrar habilidades técnicas, arquitetura e organização de código**, não representando um produto final comercial.

---

## 📄 Licença

Projeto disponibilizado exclusivamente para fins educacionais e de portfólio.
